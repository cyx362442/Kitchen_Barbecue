package com.duowei.kitchen_barbecue.view;
 ...
 * 添加商品动画
 */
public class ShoppingCartAnimationView extends AppCompatTextView implements ValueAnimator.AnimatorUpdateListener {
